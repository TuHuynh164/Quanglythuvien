                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#" class="breadcrumb-link list_nxb cursor">Nhà xuất bản</a></li>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 m-b-20">
                    <div class="simple-card">
                        <ul class="nav nav-tabs" id="myTab5" role="tablist">
                            ...
                            <button type="button" class="btn btn-outline-primary editnxb" data-toggle="modal" data-target="#myModal1"><i class="far fa-edit"></i> Chỉnh sửa thông tin</button>
                ...
                if(x==true){
                    ...
                    $.ajax({
                        ...
                        success: function (html){
                            ...
                            var url = "nhaxuatban/profilenxb.php";
                            profile(name, url);
                        }
                    });
                }else{
