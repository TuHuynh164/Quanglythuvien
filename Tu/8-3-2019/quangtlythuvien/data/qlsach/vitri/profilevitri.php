                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link list_vitri cursor">Vị trí đặt sách</a></li>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <button type="button" class="btn btn-outline-primary editvt" data-toggle="modal" data-target="#myModal1"><i class="far fa-edit"></i> Chỉnh sửa thông tin</button>
                            ...
                            <tbody>
                                ...
                                <?php                
                                        echo  "<td natsort='".$r["theloai"]."' url='theloai/profiletheloai.php' class = 'profile'>".$r["theloai"]."</td>
                                            ...
                                            <td >".tong_sach($r["Id"])."/".tong_sach_trong_kho($r["Id"])."</td>
                                            <td><i class='fas fa-exchange-alt change' data-toggle='modal' data-target='#myModal1'></i></td></tr>";
                                    }
                                ?>
                            </tbody>
                        </table>
...
<script>
    ...
    $(document).ready(function(){
        $(".change").click(function(){
            ...
            // alert(Id);
            $("#formloading1").load("../data/qlsach/vitri/changevt.php",{
                Id:Id,
                name:name
            });
        });
