                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
                                        <ul class="list-unstyled arrow">
                                            ...
                                            <li>Tên: <b> <?=$r['Ten']?> </b></li>
                                            <li>Địa chỉ: <b natsort='<?php echo $r["Dia_chi"]; ?>' url='theloai/profiletheloai.php' class = 'profile'> <?php echo $r["Dia_chi"]; ?> </b></li>
                                            <li>Email: <b natsort='<?php echo $r["Email"]; ?>' url='nhaxuatban/profilenxb.php' class = 'profile'> <?php echo $r["Email"]; ?> </b></li>
                                            <li>Ghi chú: <b> <?=$r['Ghi_chu']?> </b></li>
                                            <li natsort='<?=$r['CMND']?>' url='bandoc/detailcard.php' class = 'profile_card'>Mã thẻ (CMND): <b> <?=$r['CMND']?> </b></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                        <div class="product-thumbnail">
                                            ...
                                            <div class="product-content">
                                                <div class="product-content-head">
                                                    <h3 class="product-title id-card">Thẻ số : <?php echo $r2["So_the"]; ?></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
