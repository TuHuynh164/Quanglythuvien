            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Danh sách bạn đọc</h2>
                        <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a class="breadcrumb-link">Bạn đọc</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Danh sách bạn đọc</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered first">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            while($r=$dt->fetch()){
                                                echo "<tr>  <td>".$r["Id"]."</td> 
                                                <td natsort='".$r["Id"]."' url='bandoc/profilemember.php' id=".$r["CMND"]." class = 'profile_member cursor' title='Chi tiết'>".$r["Ten"]."</td>";
                                            ?>

                                            <?php
                                                echo "<td class = 'profile'>".$r["Dia_chi"]."</td>
                                                <td class = 'profile'>".$r["Sdt"]."</td>
                                                <td class = 'profile'>".$r["Email"]."</td>
                                                <td class = 'profile'>".$r["Ghi_chu"]."</td>
                                                <td natsort='".$r["CMND"]."' url='bandoc/detailcard.php' class = 'profile_card'>".$r["CMND"]."</td>
                                                <td>0</td>
